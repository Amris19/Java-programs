        ...
        switch(connection)
        {
            case "domestic":
                if(totalread<=100)
                {
                    ...
                    //System.out.println("The electric bill is:"+totalread*1.50);
                    break;
                }
                else if(totalread>=101 && totalread<=200)
                {
                    amount=(100*1.50)+(totalread-100)*3;
                    //System.out.println("The electric bill is:"+((100*1.50)+(totalread-100)*3));
                    break;
                }
                else if(totalread>=201 && totalread<=500)
                {
                    amount=(100*1.50)+(100*3)+(totalread-200)*4.50;
                    //System.out.println("The electric bill is:"+((100*1.50)+(100*3)+(totalread-200)*4.50));
                    break;
                }
                else
                {
            ...
            case "commercial":
                if(totalread<=100)
                {
                    ...
                    //System.out.println("The electric bill is:"+(totalread*2.50));
                    break;
                }
                else if(totalread>=101 && totalread<=200)
                {
                    amount=(100*2.50)+(totalread-100)*5;
                    //System.out.println("The electric bill is:"+((100*2.50)+(totalread-100)*5));
                    break;
                }
                else if(totalread>=201 && totalread<=500)
                {
                    amount=(100*2.50)+(100*5)+(totalread-200)*6.50;
                    //System.out.println("The electric bill is:"+((100*2.50)+(100*5)+(totalread-200)*6.50));
                ...
                else
                {
                    ...
                    //System.out.println("The electric bill is:"+((100*2.50)+(100*5)+(300*6.50)+(totalread-500)*9));
                    break;
                }
